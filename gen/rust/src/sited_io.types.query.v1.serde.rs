...
impl serde::Serialize for PaginationRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sited_io.types.query.v1.PaginationRequest", len)?;
        if self.page != 0 {
...
impl<'de> serde::Deserialize<'de> for PaginationRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sited_io.types.query.v1.PaginationRequest")
            }
        ...
        deserializer.deserialize_struct("sited_io.types.query.v1.PaginationRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PaginationResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("sited_io.types.query.v1.PaginationResponse", len)?;
        if self.page != 0 {
            struct_ser.serialize_field("page", &self.page)?;
        }
        if self.size != 0 {
...
impl<'de> serde::Deserialize<'de> for PaginationResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct sited_io.types.query.v1.PaginationResponse")
            }
        ...
        deserializer.deserialize_struct("sited_io.types.query.v1.PaginationResponse", FIELDS, GeneratedVisitor)
    }
}
