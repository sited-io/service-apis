...
pub mod customization_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct CustomizationServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl CustomizationServiceClient<tonic::transport::Channel> {
    ...
    impl<T> CustomizationServiceClient<T>
    where
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> CustomizationServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            CustomizationServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        pub async fn update_customization(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateCustomizationRequest>,
        ) -> std::result::Result<
        ...
        pub async fn put_logo_image(
            &mut self,
            request: impl tonic::IntoRequest<super::PutLogoImageRequest>,
        ) -> std::result::Result<
        ...
        pub async fn remove_logo_image(
            &mut self,
            request: impl tonic::IntoRequest<super::RemoveLogoImageRequest>,
        ) -> std::result::Result<
...
pub mod customization_service_server {
    ...
    #[async_trait]
    pub trait CustomizationService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct CustomizationServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> CustomizationServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for CustomizationServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "sited_io.websites.v1.CustomizationService";
    impl<T> tonic::server::NamedService for CustomizationServiceServer<T> {
...
pub mod domain_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sited_io.websites.v1.DomainService", "CreateDomain"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn check_domain_status(
            &mut self,
            request: impl tonic::IntoRequest<super::CheckDomainStatusRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sited_io.websites.v1.DomainService", "DeleteDomain"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod domain_service_server {
    ...
    #[async_trait]
    pub trait DomainService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct DomainServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> Clone for DomainServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sited_io.websites.v1.DomainService";
    impl<T> tonic::server::NamedService for DomainServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod page_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sited_io.websites.v1.PageService", "CreatePage"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sited_io.websites.v1.PageService", "GetPage"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sited_io.websites.v1.PageService", "ListPages"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sited_io.websites.v1.PageService", "UpdatePage"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sited_io.websites.v1.PageService", "DeletePage"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod page_service_server {
    ...
    #[async_trait]
    pub trait PageService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct PageServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> Clone for PageServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sited_io.websites.v1.PageService";
    impl<T> tonic::server::NamedService for PageServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod static_page_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct StaticPageServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl StaticPageServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> StaticPageServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::BoxBody>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> StaticPageServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            StaticPageServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn get_static_page(
            &mut self,
            request: impl tonic::IntoRequest<super::GetStaticPageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetStaticPageResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sited_io.websites.v1.StaticPageService/GetStaticPage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn update_static_page(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateStaticPageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateStaticPageResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
/// Generated server implementations.
pub mod static_page_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with StaticPageServiceServer.
    #[async_trait]
    pub trait StaticPageService: std::marker::Send + std::marker::Sync + 'static {
        async fn get_static_page(
            &self,
            request: tonic::Request<super::GetStaticPageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetStaticPageResponse>,
            tonic::Status,
        >;
        async fn update_static_page(
            &self,
            request: tonic::Request<super::UpdateStaticPageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateStaticPageResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct StaticPageServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> StaticPageServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for StaticPageServiceServer<T>
    where
        T: StaticPageService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sited_io.websites.v1.StaticPageService/GetStaticPage" => {
                    #[allow(non_camel_case_types)]
                    struct GetStaticPageSvc<T: StaticPageService>(pub Arc<T>);
                    impl<
                        T: StaticPageService,
                    > tonic::server::UnaryService<super::GetStaticPageRequest>
                    for GetStaticPageSvc<T> {
                        type Response = super::GetStaticPageResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StaticPageService>::get_static_page(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetStaticPageSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/sited_io.websites.v1.StaticPageService/UpdateStaticPage" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateStaticPageSvc<T: StaticPageService>(pub Arc<T>);
                    impl<
                        T: StaticPageService,
                    > tonic::server::UnaryService<super::UpdateStaticPageRequest>
                    for UpdateStaticPageSvc<T> {
                        type Response = super::UpdateStaticPageResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StaticPageService>::update_static_page(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateStaticPageSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for StaticPageServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sited_io.websites.v1.StaticPageService";
    impl<T> tonic::server::NamedService for StaticPageServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod website_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct WebsiteServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl WebsiteServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> WebsiteServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            WebsiteServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn create_website(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateWebsiteRequest>,
        ) -> std::result::Result<
        ...
        pub async fn get_website(
            &mut self,
            request: impl tonic::IntoRequest<super::GetWebsiteRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sited_io.websites.v1.WebsiteService", "GetWebsite"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn list_websites(
            &mut self,
            request: impl tonic::IntoRequest<super::ListWebsitesRequest>,
        ) -> std::result::Result<
        ...
        pub async fn update_website(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateWebsiteRequest>,
        ) -> std::result::Result<
        ...
        pub async fn delete_website(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteWebsiteRequest>,
        ) -> std::result::Result<
...
pub mod website_service_server {
    ...
    #[async_trait]
    pub trait WebsiteService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct WebsiteServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> Clone for WebsiteServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sited_io.websites.v1.WebsiteService";
    impl<T> tonic::server::NamedService for WebsiteServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
